...
some other ruleset that depends on rules_toolchains, or in a nested
...
```sh
OVERRIDE="--override_repository=rules_toolchains=$(pwd)/rules_toolchains"
echo "common $OVERRIDE" >> ~/.bazelrc
```

This means that any usage of `@rules_toolchains` on your system will point to this folder.
...
https://github.com/matts1/rules_toolchains/actions/workflows/tag.yaml
