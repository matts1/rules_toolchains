...
load("//toolchains/private:collect.bzl", "collect_provider", "collect_args_lists")
load("//toolchains:toolchain_info.bzl", "FeatureInfo", "FeatureSetInfo", "ArgsListInfo")
    ...
    if inputs_file:
        ...
        ctx.actions.run(
            ...
            env = {
                ...
                "FEATURES": "\n".join([
                    str(ft.label) for ft in  action.features.values()
                ]),
