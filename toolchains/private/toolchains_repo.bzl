...
# By default all these toolchains are registered by the toolchains_register_toolchains macro
...
toolchain(
    ...
    toolchain = "@{user_repository_name}_{platform}//:toolchains_toolchain",
    toolchain_type = "@rules_toolchains//toolchains:toolchain_type",
)
""".format(
            platform = platform,
